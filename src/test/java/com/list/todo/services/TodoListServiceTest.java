...
//        when(todoListRepository.findDistinctByCreatedByAndTodoListStatusAndTasksInAndTodoListNameLike(USER_USERNAME, TodoListStatus.ACTIVE, pageable, new ArrayList<>(tasks), )).thenReturn(todoListPage);
//
//        //act
...
//                .findByTodoListNameLikeAndCreatedByAndTodoListStatus(TODO_LIST_NAME + "%",
...
//        verify(todoListRepository, times(1)).findByTodoListNameLikeAndCreatedByAndTodoListStatus(TODO_LIST_NAME + "%", USER_USERNAME, TodoListStatus.ACTIVE, pageable);
//    }
//}